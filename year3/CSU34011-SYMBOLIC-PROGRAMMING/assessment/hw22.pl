...
s --> house(Col1,Nat1,Pet1),house(Col2,Nat2,Pet2),house(Col3,Nat3,Pet3),{Col1\==Col2,Col1\==Col3,Col2\==Col3},{Nat1\==Nat2,Nat1\==Nat3,Nat2\==Nat3},{Pet1\==Pet2,Pet1\==Pet3,Pet2\==Pet3}.